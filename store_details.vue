                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="map" class="margin_20">
                                <mapplic-png-map ref="pngmap_ref" :height="312" :hovertip="true" :storelist="allStores" :floorlist="floorList" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height" @updateMap="updatePNGMap"></mapplic-png-map>
                            </div>
        ...
        return Vue.component("store-details-component", {
            ...
            methods: {
                loadData: async function () {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "stores"), this.$store.dispatch("getData","promotions"), this.$store.dispatch("getData","jobs")]);
                    } catch (e) {
