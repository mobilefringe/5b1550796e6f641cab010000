                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="map" class="margin_20">
                                <mapplic-png-map ref="pngmap_ref" :height="315" :hovertip="true" :storelist="allStores" :floorlist="floorList" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height" @updateMap="updatePNGMap"></mapplic-png-map>
                            </div>
