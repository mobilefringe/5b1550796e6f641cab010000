            ...
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="location_image_container">
                    <div v-if="lowerBanner">
                        <div class="location_banner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url(' + lowerBanner.image_url + ') center center fixed' }"></div>
