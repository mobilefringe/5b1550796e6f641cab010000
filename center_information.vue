            ...
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="location_image_container">
                    <div v-if="lowerBanner">
                        <div class="location_banner" v-bind:style="{ background: 'url(' + lowerBanner.image_url + '), linear-gradient(0deg, rgba(0,0,0,0.8), rgba(0,0,0,0.8)) center center fixed' }"></div>
