		...
		return Vue.component("location-component", {
            ...
            methods: {
                loadData: async function () {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "events"), this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/cerritos-location.json"})]);
                        return results;
                    } catch (e) {
